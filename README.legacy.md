# AutoByte README — LEGACY (archived)

This is the original README for AutoByte before it became an AI troubleshooting
agent. Kept for history. The current project is documented in `README.md`
(headline feature: the local Windows AI agent in `AutoByte-Agent/`).
